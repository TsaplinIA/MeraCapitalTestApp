...
def upgrade() -> None:
    ...
    op.create_table(
        'currencies',
        sa.Column('currency_idx', sa.UUID(), nullable=False),
        sa.Column('ticker', sa.String(length=8), nullable=False),
        sa.Column('index_price_name', sa.String(length=32), nullable=False),
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('pricestamps', sa.Column('ticker', sa.String(length=8), autoincrement=False, nullable=False))
